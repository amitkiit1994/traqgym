...
export function MemberNav({ memberName }: { memberName: string }) {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-border/50 bg-background/70 backdrop-blur-2xl backdrop-saturate-[1.4] shadow-[0_1px_8px_oklch(0.565_0.20_25_/_5%)] dark:shadow-[0_1px_20px_oklch(0.65_0.18_25_/_4%)]">
