              ...
              <div className="p-5 sm:p-8 md:p-10">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground text-sm mt-2 leading-relaxed">
                    Self-service password reset is coming soon. In the meantime,
                    please contact your gym administrator to have your password
                    reset for you.
                  </p>
                </div>

                <div className="rounded-xl border border-border/60 bg-muted/30 dark:bg-white/[0.02] p-4 text-sm text-muted-foreground space-y-1.5">
                  <p className="font-medium text-foreground/90">What to do</p>
                  <ul className="list-disc list-inside space-y-1">
                    <li>Reach out to your gym&apos;s front desk or admin.</li>
                    <li>They can issue you a new temporary password.</li>
                    <li>Sign in and change it from your profile.</li>
                  </ul>
                </div>
