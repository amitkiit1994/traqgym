...
export default function ClassesPage() {
  ...
  const heatmapColor = (count: number): string => {
    ...
    if (intensity <= 20) return "oklch(0.65 0.20 var(--brand-hue) / 0.15)";
    if (intensity <= 40) return "oklch(0.65 0.20 var(--brand-hue) / 0.30)";
    if (intensity <= 60) return "oklch(0.65 0.20 var(--brand-hue) / 0.50)";
    if (intensity <= 80) return "oklch(0.65 0.20 var(--brand-hue) / 0.70)";
    return "oklch(0.65 0.20 var(--brand-hue) / 0.90)";
  };
                    ...
                    <div className="flex items-center gap-2 mt-3 justify-end">
                      ...
                      {[0.15, 0.3, 0.5, 0.7, 0.9].map((opacity) => (
                        <div
                          ...
                          style={{
                            backgroundColor: `oklch(0.65 0.20 var(--brand-hue) / ${opacity})`,
                          }}
                        />
                      ))}
